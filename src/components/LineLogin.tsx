        ...
        <div className="px-6 pb-6">
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              <button
                disabled
                className="w-full py-4 text-lg font-medium rounded-xl text-gray-500 bg-gray-100 cursor-not-allowed shadow-lg border-2 border-gray-200 transition-all duration-200"
              >
                <div className="flex items-center justify-center">
